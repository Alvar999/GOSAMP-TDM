...
stock CreatePlayerTextDraws(playerid)
{
	...
	// khocloc
	KimCuongShow[playerid] = CreatePlayerTextDraw(playerid,501.000000, 204.000000, "");
    PlayerTextDrawBackgroundColor(playerid,KimCuongShow[playerid], 255);
    PlayerTextDrawFont(playerid,KimCuongShow[playerid], 3);
    PlayerTextDrawLetterSize(playerid,KimCuongShow[playerid], 0.380000, 1.600000);
    PlayerTextDrawColor(playerid,KimCuongShow[playerid], -1);
    PlayerTextDrawSetOutline(playerid,KimCuongShow[playerid], 0);
    PlayerTextDrawSetProportional(playerid,KimCuongShow[playerid], 1);
    PlayerTextDrawSetShadow(playerid,KimCuongShow[playerid], 1);
    PlayerTextDrawSetSelectable(playerid,KimCuongShow[playerid], 1);
    
    LOGO_SV[0] = TextDrawCreate(478.000000, 12.000000, "GOSAMP.TOP");
    TextDrawLetterSize(LOGO_SV[0], 0.399999, 2.599999);
    TextDrawAlignment(LOGO_SV[0], 1);
    TextDrawColor(LOGO_SV[0], 16711935);
    TextDrawSetShadow(LOGO_SV[0], 0);
    TextDrawSetOutline(LOGO_SV[0], -1);
    TextDrawBackgroundColor(LOGO_SV[0], 255);
    TextDrawFont(LOGO_SV[0], 2);
    TextDrawSetProportional(LOGO_SV[0], 1);
    TextDrawSetShadow(LOGO_SV[0], 0);
